...
public class Demo {
	...
	public static void main (String[] args) throws Exception {
		...
		try {
			switch (args[0]) {
			case "m2c1":
				com.pluralsight.corejdbc.m2c1.MainClass.main(null);
				break;
			case "m3c1":
				com.pluralsight.corejdbc.m3c1.MainClass.main(null);
				break;
			case "m3c2":
				com.pluralsight.corejdbc.m3c2.MainClass.main(null);
				break;
			case "m3c3":
				...
				break;
			case "m4c1":
				com.pluralsight.corejdbc.m4c1.MainClass.main(null);
				break;
			case "m4c2":
				if (args.length == 2) {
				...
				break;
			case "m4c3":
				com.pluralsight.corejdbc.m4c3.MainClass.main(null);
				break;
			case "m4c4":
				com.pluralsight.corejdbc.m4c4.MainClass.main(null);
				break;
			case "m4c5":
				com.pluralsight.corejdbc.m4c5.MainClass.main(null);
				break;
			case "m4c6":
				com.pluralsight.corejdbc.m4c6.MainClass.main(null);
				break;
			case "m5c1":
				com.pluralsight.corejdbc.m5c1.MainClass.main(null);
				break;
			case "m5c2":
				com.pluralsight.corejdbc.m5c2.MainClass.main(null);
				break;
			case "m5c3":
				com.pluralsight.corejdbc.m5c3.MainClass.main(null);
				break;
			case "m5c4":
				com.pluralsight.corejdbc.m5c4.MainClass.main(null);
				break;
			case "m6c1":
				if (args.length == 3) {
			...
			case "m6c2":
				if (args.length <= 1) {
					com.pluralsight.corejdbc.m6c2.MainClass.main(null);
				...
				break;
			case "m7c1":
				com.pluralsight.corejdbc.m7c1.MainClass.main(null);
				break;
			case "m7c2":
				if (args.length == 2) {
				...
				break;
			case "m7c3":
				com.pluralsight.corejdbc.m7c3.MainClass.main(null);
				break;
			default:
				inValidMessage();
	...
	public static void inValidMessage() {
		...
		PrintUtil.colorPrint("java -cp target/corejdbc.jar MainClass ", Color.blue, false);
